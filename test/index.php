...
define('CAMPAIGN_ID', "a46e940cacaeb16f98ea1cc4286b4a55");
define('REQUEST_LIVE_TIME', 3600);
define('ENC_KEY', '0ff907b333ce03b1367bcfeaef697cda');
define('MP_PARAM_NAME', '__lh_sess');
define('NOT_FOUND_TEXT', '<h1>Page not found</h1>');
define('CHECK_MCPROXY', 0);
define('CHECK_MCPROXY_PARAM', '9d4c994e5a22eca1b11b64ff7e4f7509');
define('CHECK_MCPROXY_VALUE', 'a3c55641a815cbfa6201de584129bfd099814b34e0e70c9df467f40d56162df2');
...
function sendRequest($data, $path = 'index') {
    ...
    $data_to_post = array("cmp"=> CAMPAIGN_ID,"headers" => $data,"adapi" => '2.2', "sv" => '18776.3');
